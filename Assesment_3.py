sandwich_list = {
    ...
    "2": {"name": "Thai beef sandwich", "price": 16.00},
    "3": {"name": "Garlic Aioli BLT sandwich", "price": 14.90},
    "4": {"name": "Italian Beef sandwich", "price": 16.90},
    "5": {"name": "Philadelphia Roast Pork sandwich", "price": 16.90},
    "6": {"name": "Mediterranean veggie and haloumi sandwich", "price": 16.00},
    "7": {"name": "Chicken, pear, spinach and celery sandwich", "price": 14.90},
    "8": {"name": "Chicken, brie and cranberry sandwich", "price": 15.99},
    "9": {"name": "Tuna melt with green goddess peas sandwich", "price": 14.90}
}
